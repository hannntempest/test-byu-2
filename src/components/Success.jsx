  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-blue-300 flex flex-col items-center justify-center px-4">
      <div className="text-center">
        {/* Header */}
        <h1 className="text-xl md:text-3xl font-bold text-gray-900 mb-4">Bukti Pembayaran Berhasil Diupload</h1>
      ...
      {/* Confirmation Box */}
      <div className="bg-white shadow-lg rounded-lg p-4 md:p-6 w-full sm:w-3/4 lg:w-2/5 mb-8">
